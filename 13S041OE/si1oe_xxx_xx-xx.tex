...
\ifthenelse{\boolean{ispit}}{ %Ispitna varijanta
    \textbf{\large Први колоквијум}. \hrulefill \\
    \noindent
    \textbf{Задатак}. \\[0.5mm]
    \renewcommand{\ID}{1}\input{zadaci/Z1t.tex}\\[10mm]
    \noindent\textbf{Питања.} \\[.5mm]
    \renewcommand{\ID}{1}\input{pitanja/P1t.tex}\\[10mm]
    \renewcommand{\ID}{2}\input{pitanja/P2t.tex}\\[10mm]

    \noindent
    \textbf{\large Други колоквијум}. \hrulefill \\
    \noindent
    \textbf{Задатак}. \\[0.5mm]
    \renewcommand{\ID}{2}\input{zadaci/Z2t.tex}\\[10mm]
    \noindent\textbf{Питања.} \\[1mm]
    \renewcommand{\ID}{3}\input{pitanja/P3t.tex}\\[10mm]
    \renewcommand{\ID}{4}\input{pitanja/P4t.tex}\\[10mm]
    ...
    \noindent
    \textbf{Задатак}. \\[0.5mm]
    \renewcommand{\ID}{3}\input{zadaci/Z3t.tex}\\[10mm]

    \noindent\textbf{Питања.} \\[0.5mm]
    \renewcommand{\ID}{5}\input{pitanja/P5t.tex}\\[10mm]
    \renewcommand{\ID}{6}\input{pitanja/P6t.tex}\\[10mm]
}
{ %Kolokvijumska varijanta
    \noindent\textbf{Питања.} \\[.5mm]
    \renewcommand{\ID}{1}\input{pitanja/P1t.tex}\\[10mm]
    \renewcommand{\ID}{2}\input{pitanja/P2t.tex}\\[10mm]
    \renewcommand{\ID}{3}\input{pitanja/P3t.tex}\\[10mm]
...
\newpage % Resenja pitanja i zadataka

\printheader
\begin{center}    
    \large \textbf{Одговори на питања и решења задатака}    
\end{center}
...
\renewcommand{\ID}{1}\input{pitanja/P1s.tex}\\[10mm]
\renewcommand{\ID}{2}\input{pitanja/P2s.tex}\\[10mm]
\renewcommand{\ID}{3}\input{pitanja/P3s.tex}\\[10mm]
\renewcommand{\ID}{4}\input{pitanja/P4s.tex}\\[10mm]
\ifthenelse{\boolean{ispit}}
{
\renewcommand{\ID}{5}\input{pitanja/P5s.tex}\\[10mm]
\renewcommand{\ID}{6}\input{pitanja/P6s.tex}\\[10mm]
}{}
...
\renewcommand{\ID}{1}\input{zadaci/Z1s.tex}\\[10mm]
\renewcommand{\ID}{2}\input{zadaci/Z2s.tex}\\[10mm]
\ifthenelse{\boolean{ispit}}{
